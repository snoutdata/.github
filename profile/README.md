...
- **Multi-tab SQL editor** with schema-aware autocompletion and hover, powered by a
  real language server.
- **Connect to your databases** — MySQL / Aurora, PostgreSQL, and SQL Server, with
  optional SSH tunneling. Credentials are encrypted by your OS keychain, never in plain
  text.
